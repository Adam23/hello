			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form accept-charset="UTF-8" action="/account" class="new_user"
							id="new_user" method="post">
							<div style="margin: 0; padding: 0; display: inline">
								<input name="utf8" type="hidden" value="✓">
								<input name="authenticity_token" type="hidden"
									value="b77hzFBtZHEOJ1IzBLrxHfzgEzJzzWlkTuMVeDm1c/U=">
							</div>
							<div class="form-group">
								...
								<input autofocus="autofocus" class="form-control"
									id="user_username" name="user[username]" type="text">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<input class="form-control" id="user_email" name="user[email]"
									type="email" value="">
							</div>
							<div class="form-group">
								...
								<input class="form-control" id="user_phone" name="user[phone]"
									type="phone" value="">
							</div>
							<div class="form-group">
								...
								<input class="form-control" id="user_birthday" name="user[birthday]"
									type="datetime" value="">
							</div>
							<div>
